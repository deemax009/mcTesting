...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.ClientBaseAddressData();
  });
  ...
  describe('ClientBaseAddressData', function() {
    it('should create an instance of ClientBaseAddressData', function() {
      // uncomment below and update the code to test ClientBaseAddressData
      //var instance = new MastercardProcessingCoreApi.ClientBaseAddressData();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.ClientBaseAddressData);
    });
