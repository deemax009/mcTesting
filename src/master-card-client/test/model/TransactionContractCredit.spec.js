...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.TransactionContractCredit();
  });
  ...
  describe('TransactionContractCredit', function() {
    it('should create an instance of TransactionContractCredit', function() {
      // uncomment below and update the code to test TransactionContractCredit
      //var instance = new MastercardProcessingCoreApi.TransactionContractCredit();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.TransactionContractCredit);
    });
    ...
    it('should have the property transactionTypeExtension (base name: "transactionTypeExtension")', function() {
      // uncomment below and update the code to test the property transactionTypeExtension
      //var instance = new MastercardProcessingCoreApi.TransactionContractCredit();
      //expect(instance).to.be();
    });

    it('should have the property uniqueReferenceNumber (base name: "uniqueReferenceNumber")', function() {
