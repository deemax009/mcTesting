...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.BaseAddress();
  });
  ...
  describe('BaseAddress', function() {
    it('should create an instance of BaseAddress', function() {
      // uncomment below and update the code to test BaseAddress
      //var instance = new MastercardProcessingCoreApi.BaseAddress();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.BaseAddress);
    });
