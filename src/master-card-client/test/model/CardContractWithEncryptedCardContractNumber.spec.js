...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.CardContractWithEncryptedCardContractNumber();
  });
  ...
  describe('CardContractWithEncryptedCardContractNumber', function() {
    it('should create an instance of CardContractWithEncryptedCardContractNumber', function() {
      // uncomment below and update the code to test CardContractWithEncryptedCardContractNumber
      //var instance = new MastercardProcessingCoreApi.CardContractWithEncryptedCardContractNumber();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.CardContractWithEncryptedCardContractNumber);
    });
    ...
    it('should have the property encryptedCardContractNumber (base name: "encryptedCardContractNumber")', function() {
      // uncomment below and update the code to test the property encryptedCardContractNumber
      //var instance = new MastercardProcessingCoreApi.CardContractWithEncryptedCardContractNumber();
      //expect(instance).to.be();
    });
