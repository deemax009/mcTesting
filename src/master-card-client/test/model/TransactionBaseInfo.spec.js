...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.TransactionBaseInfo();
  });
  ...
  describe('TransactionBaseInfo', function() {
    it('should create an instance of TransactionBaseInfo', function() {
      // uncomment below and update the code to test TransactionBaseInfo
      //var instance = new MastercardProcessingCoreApi.TransactionBaseInfo();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.TransactionBaseInfo);
    });
    ...
    it('should have the property postingStatus (base name: "postingStatus")', function() {
