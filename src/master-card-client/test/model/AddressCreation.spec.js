...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.AddressCreation();
  });
  ...
  describe('AddressCreation', function() {
    it('should create an instance of AddressCreation', function() {
      // uncomment below and update the code to test AddressCreation
      //var instance = new MastercardProcessingCoreApi.AddressCreation();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.AddressCreation);
    });
