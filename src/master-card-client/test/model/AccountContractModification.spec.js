...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.AccountContractModification();
  });
  ...
  describe('AccountContractModification', function() {
    it('should create an instance of AccountContractModification', function() {
      // uncomment below and update the code to test AccountContractModification
      //var instance = new MastercardProcessingCoreApi.AccountContractModification();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.AccountContractModification);
    });
