...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.UsageLimitModification();
  });
  ...
  describe('UsageLimitModification', function() {
    it('should create an instance of UsageLimitModification', function() {
      // uncomment below and update the code to test UsageLimitModification
      //var instance = new MastercardProcessingCoreApi.UsageLimitModification();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.UsageLimitModification);
    });
