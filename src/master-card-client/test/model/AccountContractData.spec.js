...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.AccountContractData();
  });
  ...
  describe('AccountContractData', function() {
    it('should create an instance of AccountContractData', function() {
      // uncomment below and update the code to test AccountContractData
      //var instance = new MastercardProcessingCoreApi.AccountContractData();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.AccountContractData);
    });
    ...
    it('should have the property accountContractSubtypeCode (base name: "accountContractSubtypeCode")', function() {
      // uncomment below and update the code to test the property accountContractSubtypeCode
      //var instance = new MastercardProcessingCoreApi.AccountContractData();
      //expect(instance).to.be();
    });
