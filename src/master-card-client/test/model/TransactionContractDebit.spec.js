...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.TransactionContractDebit();
  });
  ...
  describe('TransactionContractDebit', function() {
    it('should create an instance of TransactionContractDebit', function() {
      // uncomment below and update the code to test TransactionContractDebit
      //var instance = new MastercardProcessingCoreApi.TransactionContractDebit();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.TransactionContractDebit);
    });
