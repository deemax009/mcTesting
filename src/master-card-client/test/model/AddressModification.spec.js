...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.AddressModification();
  });
  ...
  describe('AddressModification', function() {
    it('should create an instance of AddressModification', function() {
      // uncomment below and update the code to test AddressModification
      //var instance = new MastercardProcessingCoreApi.AddressModification();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.AddressModification);
    });
