...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardProcessingCoreApi.CardContractSummary();
  });
  ...
  describe('CardContractSummary', function() {
    it('should create an instance of CardContractSummary', function() {
      // uncomment below and update the code to test CardContractSummary
      //var instance = new MastercardProcessingCoreApi.CardContractSummary();
      //expect(instance).to.be.a(MastercardProcessingCoreApi.CardContractSummary);
    });
    ...
    it('should have the property baseCardContractStatusData (base name: "baseCardContractStatusData")', function() {
      // uncomment below and update the code to test the property baseCardContractStatusData
      //var instance = new MastercardProcessingCoreApi.CardContractSummary();
      //expect(instance).to.be();
    });
