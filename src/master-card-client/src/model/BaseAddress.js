...
/**
 * The BaseAddress model module.
 * @module model/BaseAddress
 * @version 1.0.0
 */
class BaseAddress {
    /**
     * Constructs a new <code>BaseAddress</code>.
     * @alias module:model/BaseAddress
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>BaseAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseAddress} obj Optional instance to populate.
     * @return {module:model/BaseAddress} The populated <code>BaseAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseAddress</code>.
     */
