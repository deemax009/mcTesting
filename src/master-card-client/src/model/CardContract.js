...
/**
 * The CardContract model module.
 * @module model/CardContract
 * @version 1.0.0
 */
class CardContract {
    /**
     * Constructs a new <code>CardContract</code>.
     * @alias module:model/CardContract
    ...
    /**
     * Constructs a <code>CardContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CardContract} obj Optional instance to populate.
     * @return {module:model/CardContract} The populated <code>CardContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CardContract();
    ...
    /**
     * Validates the JSON data with respect to <code>CardContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CardContract</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CardContract.RequiredProperties) {
...
CardContract.RequiredProperties = ["accountContractId", "cardContractId", "cardContractNumber", "cardholderId"];
