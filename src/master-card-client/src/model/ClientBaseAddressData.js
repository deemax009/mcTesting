...
/**
 * The ClientBaseAddressData model module.
 * @module model/ClientBaseAddressData
 * @version 1.0.0
 */
class ClientBaseAddressData {
    /**
     * Constructs a new <code>ClientBaseAddressData</code>.
     * Client&#39;s base address stored in the MP&#39;s CMS at the client level. 
     * @alias module:model/ClientBaseAddressData
     */
    constructor() { 
        
        ClientBaseAddressData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientBaseAddressData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientBaseAddressData} obj Optional instance to populate.
     * @return {module:model/ClientBaseAddressData} The populated <code>ClientBaseAddressData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientBaseAddressData();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientBaseAddressData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientBaseAddressData</code>.
     */
 ...
 */
ClientBaseAddressData.prototype['addressLine1'] = undefined;

/**
 * Second address line. 
 * @member {String} addressLine2
 */
ClientBaseAddressData.prototype['addressLine2'] = undefined;

/**
 * Third address line. 
 * @member {String} addressLine3
 */
ClientBaseAddressData.prototype['addressLine3'] = undefined;

/**
 * Fourth address line. 
 * @member {String} addressLine4
 */
ClientBaseAddressData.prototype['addressLine4'] = undefined;

/**
 * City. 
 * @member {String} city
 */
ClientBaseAddressData.prototype['city'] = undefined;

/**
 * Three-letter country code (format according to ISO-3166, alpha-3 specification). 
 * @member {String} country
 */
ClientBaseAddressData.prototype['country'] = undefined;

/**
 * Postal code. The MP's CMS will not validate the correctness of the postal code. 
 * @member {String} postalCode
 */
ClientBaseAddressData.prototype['postalCode'] = undefined;

/**
 * State. The MP's CMS will not validate the correctness of the state name. 
 * @member {String} state
 */
ClientBaseAddressData.prototype['state'] = undefined;
...
export default ClientBaseAddressData;
