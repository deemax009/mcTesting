# MastercardProcessingCoreApi.CardContract
...
**availableBalance** | **Number** | Available card balance.  The field can contain values up to 4 decimal places. A dot is used as a decimal separator.  | [optional] 
...
**cardContractStatusData** | [**CardContractStatusData**](CardContractStatusData.md) |  | [optional] 
