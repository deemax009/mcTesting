...
/**
 * The CheckoutDigitalCardData model module.
 * @module model/CheckoutDigitalCardData
 * @version 1.3.2
 */
class CheckoutDigitalCardData {
    /**
     * Constructs a new <code>CheckoutDigitalCardData</code>.
     ...
     * @alias module:model/CheckoutDigitalCardData
    ...
    constructor(descriptorName, artUri) { 
        ...
        CheckoutDigitalCardData.initialize(this, descriptorName, artUri);
    }
    ...
    /**
     * Constructs a <code>CheckoutDigitalCardData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckoutDigitalCardData} obj Optional instance to populate.
     * @return {module:model/CheckoutDigitalCardData} The populated <code>CheckoutDigitalCardData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckoutDigitalCardData();
    ...
    /**
     * Validates the JSON data with respect to <code>CheckoutDigitalCardData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckoutDigitalCardData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CheckoutDigitalCardData.RequiredProperties) {
...
CheckoutDigitalCardData.RequiredProperties = ["descriptorName", "artUri"];
 ...
 */
CheckoutDigitalCardData.prototype['presentationName'] = undefined;
 ...
 */
CheckoutDigitalCardData.prototype['descriptorName'] = undefined;
...
export default CheckoutDigitalCardData;
