...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PhoneNumber();
  });
  ...
  describe('PhoneNumber', function() {
    it('should create an instance of PhoneNumber', function() {
      ...
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PhoneNumber();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PhoneNumber);
    });
