...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.MaskedAddress();
  });
  ...
  describe('MaskedAddress', function() {
    it('should create an instance of MaskedAddress', function() {
      // uncomment below and update the code to test MaskedAddress
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.MaskedAddress();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.MaskedAddress);
    });
    ...
    it('should have the property lastUsedTime (base name: "lastUsedTime")', function() {
      // uncomment below and update the code to test the property lastUsedTime
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.MaskedAddress();
      //expect(instance).to.be();
    });
