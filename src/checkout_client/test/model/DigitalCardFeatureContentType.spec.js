...
(function(root, factory) {
  ...
  describe('DigitalCardFeatureContentType', function() {
    it('should create an instance of DigitalCardFeatureContentType', function() {
      // uncomment below and update the code to test DigitalCardFeatureContentType
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DigitalCardFeatureContentType();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DigitalCardFeatureContentType);
    });
