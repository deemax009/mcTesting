...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.AccountReference();
  });
  ...
  describe('AccountReference', function() {
    it('should create an instance of AccountReference', function() {
      // uncomment below and update the code to test AccountReference
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.AccountReference();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.AccountReference);
    });
