...
(function(root, factory) {
  ...
  describe('DynamicDataType', function() {
    it('should create an instance of DynamicDataType', function() {
      // uncomment below and update the code to test DynamicDataType
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DynamicDataType();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DynamicDataType);
    });
