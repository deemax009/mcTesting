...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PaymentOptions();
  });
  ...
  describe('PaymentOptions', function() {
    it('should create an instance of PaymentOptions', function() {
      ...
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PaymentOptions();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.PaymentOptions);
    });
