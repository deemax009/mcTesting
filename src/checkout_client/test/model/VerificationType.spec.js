...
(function(root, factory) {
  ...
  describe('VerificationType', function() {
    it('should create an instance of VerificationType', function() {
      // uncomment below and update the code to test VerificationType
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.VerificationType();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.VerificationType);
    });
