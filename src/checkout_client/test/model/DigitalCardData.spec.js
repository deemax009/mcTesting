...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DigitalCardData();
  });
  ...
  describe('DigitalCardData', function() {
    it('should create an instance of DigitalCardData', function() {
      // uncomment below and update the code to test DigitalCardData
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DigitalCardData();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.DigitalCardData);
    });
