...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.ThreeDsOutputData();
  });
  ...
  describe('ThreeDsOutputData', function() {
    it('should create an instance of ThreeDsOutputData', function() {
      // uncomment below and update the code to test ThreeDsOutputData
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.ThreeDsOutputData();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.ThreeDsOutputData);
    });
