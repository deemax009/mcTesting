...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.TransactionAmount();
  });
  ...
  describe('TransactionAmount', function() {
    it('should create an instance of TransactionAmount', function() {
      // uncomment below and update the code to test TransactionAmount
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.TransactionAmount();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.TransactionAmount);
    });
