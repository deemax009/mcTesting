...
(function(root, factory) {
  ...
  describe('CheckoutType', function() {
    it('should create an instance of CheckoutType', function() {
      // uncomment below and update the code to test CheckoutType
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutType();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutType);
    });
