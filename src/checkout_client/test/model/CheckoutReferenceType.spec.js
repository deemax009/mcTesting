...
(function(root, factory) {
  ...
  describe('CheckoutReferenceType', function() {
    it('should create an instance of CheckoutReferenceType', function() {
      // uncomment below and update the code to test CheckoutReferenceType
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutReferenceType();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutReferenceType);
    });
