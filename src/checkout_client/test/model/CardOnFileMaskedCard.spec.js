...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CardOnFileMaskedCard();
  });
  ...
  describe('CardOnFileMaskedCard', function() {
    it('should create an instance of CardOnFileMaskedCard', function() {
      // uncomment below and update the code to test CardOnFileMaskedCard
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CardOnFileMaskedCard();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CardOnFileMaskedCard);
    });
