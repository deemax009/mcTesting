...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutCardResponse();
  });
  ...
  describe('CheckoutCardResponse', function() {
    it('should create an instance of CheckoutCardResponse', function() {
      // uncomment below and update the code to test CheckoutCardResponse
      //var instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutCardResponse();
      //expect(instance).to.be.a(CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CheckoutCardResponse);
    });
