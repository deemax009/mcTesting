...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.TransactionConfirmationApi();
  });
  ...
  describe('TransactionConfirmationApi', function() {
    describe('postConfirmation', function() {
      it('should call postConfirmation successfully', function(done) {
        //uncomment below and update the code to test postConfirmation
        //instance.postConfirmation(function(error) {
