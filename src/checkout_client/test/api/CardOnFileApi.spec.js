...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CheckoutSaveCardOnFileDeleteSavedCardOnFileAndConfirmationsApi.CardOnFileApi();
  });
  ...
  describe('CardOnFileApi', function() {
    describe('deleteCOF', function() {
      it('should call deleteCOF successfully', function(done) {
        //uncomment below and update the code to test deleteCOF
        //instance.deleteCOF(function(error) {
    ...
    describe('saveCOF', function() {
      it('should call saveCOF successfully', function(done) {
        //uncomment below and update the code to test saveCOF
        //instance.saveCOF(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
